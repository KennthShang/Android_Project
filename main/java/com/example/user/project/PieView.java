...
public class PieView extends View {
    ...
    public void SetPie(ArrayList<Pie> pieArrayList) {
        mMaxValue = 0;
        mPieColorList.clear();mPieValue.clear();mStringList.clear();
    ...
    private void drawText(Canvas canvas, String text) {
        ...
        if (mCurrentIndex == 0) {
            canvas.drawText(text, mTextMarginLeft, mPadding + TEXT_SIZE * 0.8f +10, mPaint);
        } else {
            canvas.drawText(text, mTextMarginLeft, (mCurrentIndex) * TEXT_VERTICAL_PADDING + mPadding + TEXT_SIZE * 0.8f +10, mPaint);
        }
    }
